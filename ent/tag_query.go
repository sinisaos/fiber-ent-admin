...
func (tq *TagQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Tag, error) {
	...
	if query := tq.withQuestions; query != nil {
		if err := tq.loadQuestions(ctx, query, nodes,
			func(n *Tag) { n.Edges.Questions = []*Question{} },
			func(n *Tag, e *Question) { n.Edges.Questions = append(n.Edges.Questions, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (tq *TagQuery) loadQuestions(ctx context.Context, query *QuestionQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Question)) error {
